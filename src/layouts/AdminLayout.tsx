...
import { LayoutDashboard, Newspaper, LogOut, GraduationCap, Images, FileText, ImagePlay, Trophy, CalendarDays, Building2, Bus, Clock } from 'lucide-react'
...
const NAV_ITEMS = [
  ...
  { to: '/admin/movilizacion',  label: 'Movilización',    icon: Bus,          exact: false },
  { to: '/admin/horarios',      label: 'Horarios',         icon: Clock,        exact: false },
]

      ...
      {loading ? (
        ...
        <div className="space-y-3">
          {slides.map((slide, idx) => (
            <div
              key={slide.id}
              className={`flex gap-4 items-center bg-white rounded-xl border p-3 transition-opacity ${!slide.activo ? 'opacity-50' : 'border-gray-200'}`}
            >
              {/* Preview */}
              <img
                src={slide.src}
              ...
              <div className="flex-1 min-w-0 space-y-1.5">
                ...
                />
                <p className="text-xs text-gray-400">Posición {idx + 1} de {slides.length}</p>
